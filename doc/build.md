...
`4445d2523fcd8596de08a4459c5c7875564a2fc3`. That revision computes the
...
`19f01bf6de616db3b5a59d5f113b732ca26750ebd586430a6c50af3220cd1a25`,
size is `1,823,520` bytes, and ELF GNU build ID is
`e72f233913651db5fe6a3b03f4d039d05b930d7e`. The source revision records
...
python3 scripts/nvx.py stage-agent \
  --input build/nvx-agent-4445d25-input \
  --sha256 19f01bf6de616db3b5a59d5f113b732ca26750ebd586430a6c50af3220cd1a25
```
