...
6. [Snapshot and restore](design/snapshot-and-restore.md)
7. [Snapshot sharing and host storage](design/snapshot-sharing-and-host-storage.md)
8. [Host attachment model](design/host-attachment-model.md)
9. [Concurrency and trust boundaries](design/concurrency-and-trust-boundaries.md)
10. [Validation](design/validation.md)
11. [Current limits](design/current-limits.md)
