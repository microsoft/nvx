...
NVX runs a 23-metric OpenVMM benchmark suite on Linux/KVM and Windows/WHP. Linux/MSHV runs the
20 supported non-network metrics because OpenVMM's microVM virtio-net phase currently supports
